...
Before we get our hands dirty with regression analysis, let's go over some of the key concepts discussed in this week's class.
...
question_text("Enter the value of the lower bound of the 95% confidence interval here (rounded to digits behind the decimal):",
...
question_text("Enter the value of the upper bound of the 95% confidence interval here (rounded to digits behind the decimal):",
